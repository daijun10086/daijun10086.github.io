---
title: "Some of My Research Interests and Gradients"
date: "2026-08-07"
summary: "A brief introduction to the research topics I enjoy and hope to pursue in the future."
tags:
  - notes
---
...
Another major development is _automated research_. More and more startups are trying to build AI systems that can conduct research, both to advance AI itself and to accelerate other sciences. This raises an interesting and challenging question: what kind of research should humans focus on? If you choose to work on something that AI may master within five years, is it really worth pursuing? Would it be like deciding to become a professional Go player just before AlphaGo defeated the world's strongest players? Even a Fields Medal-winning mathematician has chosen to work on AI safety rather than continue to focus exclusively on mathematics. **So, what are the truly important—and relatively “safe”—problems for humans to study if we want to build brilliant careers?**
...
Everyone needs personal interests. As AI models become more capable, they are dramatically reducing the time required to write code and plan experiments. Just as we all have hobbies in daily life, researchers can have their own “research hobbies”—topics they pursue because they genuinely enjoy them. Mine are computational photography, imaging, and graphics. In my heart, I believe that passion is all we need, forever! And frankly speaking, though LLMs are really incredible and I basically cannot leave from LLMs in my daily life, I never get such impressive feeling compare to when I see some computational photography black magic, one of an examples is [The Moon Camera](https://www.youtube.com/watch?v=Ytkkl917paM), assume there exist multiple parallel universes, there will be no universe that I can came up this idea! Even though these magical projects cannot extend the boundary of 'intelligence', it really impressed me, a lot. From my deep heart, I enjoy these research, try to make invisible visible and show other something they never thought about. 

For graphics, it is all about ART. I like the high-end visual art, such as rendering, every pixel is worth designing. Another point that attract me a lot is, graphics give us the God's viewpoint to create the visual content we see, we simulated the underline principles and show how these things will change, pretty cool huh?
